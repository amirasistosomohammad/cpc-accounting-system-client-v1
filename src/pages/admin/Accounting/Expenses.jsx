...
const Expenses = () => {
  ...
  const fetchExpenseAccounts = async () => {
    try {
      ...
      const expenseOnly = all.filter(
        (acc) => acc.account_type_category === "expense",
      );
                ...
                >
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    >
                      {initialLoading
                        ? "..."
                        : abbreviateNumber(stats.totalExpenses, true)}
                    </div>
                    <div
                      style={{
                        marginTop: "0.25rem",
                ...
                >
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    >
                      {initialLoading
                        ? "..."
                        : abbreviateNumber(stats.expenseAccounts, false)}
                    </div>
                    <div
                      style={{
                        marginTop: "0.25rem",
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    List of expense entries by date
                  </small>
                </div>
              </div>
            </div>
            <div style={{ padding: 0 }}>
              {filteredTransactions.length === 0 ? (
                <div className="text-center py-5">
                  <div className="mb-3">
                    <i
                      className="fas fa-arrow-down fa-3x"
                  ...
                  >
                    {hasActiveFilters
                      ...
                      : "Start by creating your first expense transaction."}
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <div
                    className="d-none d-md-block table-responsive expenses-transactions-table-wrap"
                    style={{ overflowX: "auto" }}
                  >
                    <table
                      style={{
          ...
          >
            ...
            <div className="modal-footer border-top bg-white">
              <button
                ...
                onClick={handleCopy}
              >
                <i className="fas fa-copy me-2" /> Copy
              </button>
              <button
                type="button"
              ...
              <div className="modal-footer border-top bg-white">
                ...
                >
                  {submitting ? (
                    ...
                    <>
                      <FaPlus className="me-2" /> Record Expense
                    </>
                  )}
                </button>
              </div>
